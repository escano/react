var Framework7React = window['framework7-react'],
    ...
    Searchbar = Framework7React.Searchbar,
...
var LeftPanel = function LeftPanel(props, context) {
  return React.createElement(
    ...
    React.createElement(
      ...
      context.framework7AppContext.theme.ios ? React.createElement(Navbar, { title: "Video Tutorials" }) : null,
      React.createElement(
        Pages,
        null,
        React.createElement(
          Page,
          null,
          context.framework7AppContext.theme.material ? React.createElement(Navbar, { title: "Video Tutorials" }) : null,
          React.createElement(
            List,
            null,
            React.createElement(
              ListItem,
              null,
              React.createElement(Button, {href:"https://www.youtube.com/watch?v=L77b57erQ4M"},"Tutorial 1")
            ),
            React.createElement(
              ListItem,
              null,
              React.createElement(Button, {href:"https://www.youtube.com/watch?v=y6yn8NaDZuQ"},"Tutorial 2")
            ),
            React.createElement(
              ListItem,
              null,
              React.createElement(Button, {href:"https://www.youtube.com/watch?v=y6yn8NaDZuQ"},"Tutorial 3")
            ),
            React.createElement(
              ListItem,
              null,
              React.createElement(Button, {href:"https://www.youtube.com/watch?v=L77b57erQ4M"},"Tutorial 4")
            ),
          ), 
          // React.createElement(
          //   ContentBlockTitle,
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Searchbar,{onSearchbarSearch:onChangeHandler},
          ),
          React.createElement(
            ContentBlockTitle,
            null,
          ...
          React.createElement(
            List,
            null,
            React.createElement(ListItem,{media: "<img src='img/start.png' style='width:80%'>"}),
            React.createElement(
              ContentBlock,
              null,
              "Working out with consistency is important for your physical health. A consistent workout regimen reduces stress and increases your mental well being. Check out some tips for your daily workout routines in this application!"
            )
          ),
        )
      )
